...
// This is set by AuthContext once Clerk is ready
let _getToken = null;
...
export const api = {
  ...
  getStockData: () =>
    axios.get(`${API_BASE}/markets/stocks`),

  getCommodityData: () =>
    axios.get(`${API_BASE}/markets/commodities`),
  ...
  importPaytm: async (file) => {
    ...
    return axios.post(`${API_BASE}/import/paytm`, formData, {
  ...
  connectTelegram: async (chatId) =>
    axios.post(`${API_BASE}/telegram/connect`, { chat_id: chatId }, { headers: await getHeaders() }),

  sendTelegramNotification: async (message) =>
    axios.post(`${API_BASE}/telegram/notify`, null, {
      headers: await getHeaders(),
      params: { message },
    }),

  sendTransactionAlert: async (transactionId) =>
    axios.post(`${API_BASE}/telegram/alerts/transaction`, null, {
      headers: await getHeaders(),
