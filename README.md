...
### Frontend (.env)
\`\`\`env
REACT_APP_BACKEND_URL=https://crypto-tracker-172.preview.example.com
WDS_SOCKET_PORT=443
...
### Current Deployment
- **Live URL**: https://crypto-tracker-172.preview.example.com
...
- **Live App**: https://crypto-tracker-172.preview.example.com
